...
cause is penalized, and (3) total cost versus an expert technician's
baseline. Replacing parts to test hypotheses is expensive; measurements are
cheap. Finishing with no measurements at all caps your score.

When you are confident, call finish() with your diagnosis: the faulty

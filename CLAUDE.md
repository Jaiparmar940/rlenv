...
3. **Phase 2 — grader.py + tests:** score 0–100 (root cause 60 / parts discipline 25, −8 per wrong part / cost efficiency 15 vs expert baseline). Anti-cheat: symptom masking ≠ success (grader reads true world state); finish() with no measurements caps at 40. `test_grader.py` must defeat three adversarial agents: parts-cannon, lucky-guesser, symptom-masker. CHECKPOINT: run those three in front of the human.
